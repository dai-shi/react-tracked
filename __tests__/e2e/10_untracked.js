...
describe('10_untracked', () => {
  it('should work with recorded events', async () => {
    ...
    await page.waitForSelector('body > #app > ul > li:nth-child(1) > input:nth-child(2)');
    await page.click('body > #app > ul > li:nth-child(1) > input:nth-child(2)');
    expect(await page.evaluate(() => document.body.innerHTML)).toMatchSnapshot();

    await page.type('body > #app > ul > li:nth-child(1) > input:nth-child(2)', '1');
    expect(await page.evaluate(() => document.body.innerHTML)).toMatchSnapshot();
